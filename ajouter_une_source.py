...
SITE_IDENTIFIER = 'streaming, # identifant (nom de votre fichier) remplacez les espaces et les . par _ AUCUN CARACTERE SPECIAL
SITE_NAME = 'animation  # nom que KODI affiche
